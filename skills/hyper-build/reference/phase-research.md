...
This file is the authoritative instruction set for the **research** phase when hyper-build routes to it.
...
- When the recommendation is settled, append a `## Decisions` entry
  to `dashboard.md` per `reference/dashboard.md` §Decisions
