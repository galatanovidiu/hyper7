...
Resolve the Hyper state root per `reference/state-root.md` before reading or writing `.hyper/team/` paths. Codebase context, diffs, and teammate CLI commands still run in the current working tree.
